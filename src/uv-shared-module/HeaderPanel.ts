...
export class HeaderPanel extends BaseView {
    ...
    create(): void {
        ...
        Dispatcher.subscribe(BaseEvents.SHOW_INFORMATION, (e: any, args: InformationArgs) => {
        ...
        this.$informationBox.find('.close').on('click', (e) => {
            e.preventDefault();
            Dispatcher.publish(BaseEvents.HIDE_INFORMATION);
        });
        ...
        this.$settingsButton.onPressed(() => {
            Dispatcher.publish(BaseEvents.SHOW_SETTINGS_DIALOGUE);
        });
    ...
    updateSettings(settings: ISettings): void {
        ...
        Dispatcher.publish(BaseEvents.UPDATE_SETTINGS, [settings]);
    }
