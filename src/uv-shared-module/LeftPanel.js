...
define(["require", "exports", "./BaseEvents", "./BaseExpandPanel"], function (require, exports, BaseEvents_1, BaseExpandPanel_1) {
    ...
    var LeftPanel = /** @class */ (function (_super) {
        ...
        LeftPanel.prototype.create = function () {
            ...
            Dispatcher.subscribe(BaseEvents_1.BaseEvents.TOGGLE_EXPAND_LEFT_PANEL, function () {
        ...
        LeftPanel.prototype.toggleFinish = function () {
            ...
            if (this.isExpanded) {
                Dispatcher.publish(BaseEvents_1.BaseEvents.OPEN_LEFT_PANEL);
            }
            else {
                Dispatcher.publish(BaseEvents_1.BaseEvents.CLOSE_LEFT_PANEL);
            }
