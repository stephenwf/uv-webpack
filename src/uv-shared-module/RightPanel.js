...
define(["require", "exports", "./BaseEvents", "./BaseExpandPanel"], function (require, exports, BaseEvents_1, BaseExpandPanel_1) {
    ...
    var RightPanel = /** @class */ (function (_super) {
        ...
        RightPanel.prototype.init = function () {
            ...
            Dispatcher.subscribe(BaseEvents_1.BaseEvents.TOGGLE_EXPAND_RIGHT_PANEL, function () {
        ...
        RightPanel.prototype.toggleFinish = function () {
            ...
            if (this.isExpanded) {
                Dispatcher.publish(BaseEvents_1.BaseEvents.OPEN_RIGHT_PANEL);
            }
            else {
                Dispatcher.publish(BaseEvents_1.BaseEvents.CLOSE_RIGHT_PANEL);
            }
